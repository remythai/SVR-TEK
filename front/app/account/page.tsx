...
import { User, Mail, Shield, Building, TrendingUp, Edit2, Save, X, Plus, Trash2, Users } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getRoleColor(userData.role)} bg-opacity-90`}>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-4 rounded-lg border border-pink-100">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-lg font-mono text-gray-800">
                      {userData.founder_id || 'Not assigned'}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-pink-50 to-purple-50 p-4 rounded-lg border border-pink-100">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-lg font-mono text-gray-800">
                      {userData.investor_id || 'Not assigned'}
                    </span>
                  </div>
                </div>
              </div>
                      ...
                      <div className="space-y-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          <input
                            ...
                            onChange={(e) => setEditingStartup(prev => ({ ...prev, name: e.target.value }))}
                            className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          />
                          <input
                            type="text"
                            value={editingStartup.industry}
                            onChange={(e) => setEditingStartup(prev => ({ ...prev, industry: e.target.value }))}
                            className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          />
                          <select
                            value={editingStartup.stage}
                            onChange={(e) => setEditingStartup(prev => ({ ...prev, stage: e.target.value }))}
                            className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          >
                            <option value="Seed">Seed</option>
                            <option value="Series A">Series A</option>
                          ...
                          <input
                            type="number"
                            value={editingStartup.employees}
                            onChange={(e) => setEditingStartup(prev => ({ ...prev, employees: parseInt(e.target.value) }))}
                            className="px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500"
                          />
                          <div className="md:col-span-2">
                            <textarea
